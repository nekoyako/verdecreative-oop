...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <form action="/verdecreative-oop/auth/client/edit/updated.php" method="POST"> 
            <div class="card-body">
            ...
            <div class="card-footer">
                ...
                <a href="/verdecreative-oop/auth/dashboard/?menu=client" class="btn" style="color: white; background: orange">
